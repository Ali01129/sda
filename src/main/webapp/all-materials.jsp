				...
				<div class="main-wrapper">
					<div class="header">
						<div class="header-left">
							...
							<b><a href="dashboard.jsp" class="logo logo-small"
							...
							<div id="sidebar-menu" class="sidebar-menu">
								<ul>
									...
									<li class="submenu"> <a href="#"><i
												class="fa-solid fa-bars"></i></fa-solid><span>Products</span> <span
									...
									<li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i>
											<span>Materials</span> <span class="menu-arrow"></span></a>
										<ul class="submenu_class" style="display: none;">
									...
									<li class="submenu"> <a href="#"><i
												class="fa-solid fa-star"></i><span>Quality</span> <span
												class="menu-arrow"></span></a>
										<ul class="submenu_class" style="display: none;">
										...
										<div class="card-body booking_card">
											...
											<div class="table-responsive">
												<table
													...
													<tbody>
														<% Database dataAccess=new Database(); Connection
															connection=dataAccess.getConnection(); Statement
															statement=connection.createStatement(); ResultSet
															result=statement.executeQuery("SELECT * FROM rawmaterial");
															try { while (result.next()) { %>
															<tr>
																<td>
																	<%= result.getInt("RawMaterialid") %>
																</td>
																<td>
																...
																<td>
																	...
																	<a class="delete" title="Delete"
																		...
																		onclick="sendRequestWithId(this)"
																		data-material-id="<%= result.getInt("
																		RawMaterialid")%>"><i
																			class="material-icons">&#xE872;</i></a>

																	<% Boolean isValid=(Boolean)
																		request.getAttribute("valid"); if (isValid
																		!=null && !isValid) { %>
																		</p>
																		<div style="color: red;">Cannot delete Material
																		</div>
																		<% } %>
																</td>
															</tr>
						...
						<div id="delete_asset" class="modal fade delete-modal" role="dialog">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<div class="modal-body text-center"> <img src="assets/img/sent.png" alt=""
											width="50" height="46">
										<h3 class="delete_class">Do you really want to delete these records? This
											process cannot be undone.</h3>
										<div class="m-t-20"> <a href="#" class="btn btn-white"
												data-dismiss="modal">Close</a>
											<button type="submit" id="delete_button_modal"
